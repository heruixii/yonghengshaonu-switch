#!/usr/bin/env python3
"""Final static QA and ZIP build for v009 scene 1040."""
...
BUILD = ROOT / "05_build" / "v009-scene1040"
PREV = ROOT / "05_build" / "v008-systemmenu-core"
CLEAN_ROMFS = ROOT / "02_romfs" / "merged-v1.0.3"
SCENE_TSV = ROOT / "03_text" / "translated" / "scene1040-full-v1.tsv"
CUMULATIVE = ROOT / "03_text" / "translated" / "v009-cumulative.tsv"
ZIP_PATH = BUILD / "v009-scene1040-test.zip"
...
def verify_scene_reextract(errors: list[str]) -> tuple[int, int, int]:
    ...
    source_path = CLEAN_ROMFS / "Script" / "scr1040.binu8"
    patched_path = BUILD / "romfs" / "Script" / "scr1040.binu8"
...
def verify_inheritance(errors: list[str]) -> tuple[int, int, int]:
    ...
    scene_rel = f"contents/{TITLE_ID}/romfs/Script/scr1040.binu8"
    if scene_rel not in cur_files:
        errors.append("missing_new_scene1040")
