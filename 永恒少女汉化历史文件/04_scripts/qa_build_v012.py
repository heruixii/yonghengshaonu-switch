#!/usr/bin/env python3
"""Final static QA and ZIP build for v012 scene 1070."""
...
BUILD = ROOT / "05_build" / "v012-scene1070"
PREV = ROOT / "05_build" / "v011-scene1060"
CLEAN_ROMFS = ROOT / "02_romfs" / "merged-v1.0.3"
SCENE_TSV = ROOT / "03_text" / "translated" / "scene1070-full-v1.tsv"
CUMULATIVE = ROOT / "03_text" / "translated" / "v012-cumulative.tsv"
ZIP_PATH = BUILD / "v012-scene1070-test.zip"
...
def verify_scene_reextract(errors: list[str]) -> tuple[int, int, int]:
    ...
    source_path = CLEAN_ROMFS / "Script" / "scr1070.binu8"
    patched_path = BUILD / "romfs" / "Script" / "scr1070.binu8"
...
def verify_inheritance(errors: list[str]) -> tuple[int, int, int]:
    ...
    scene_rel = f"contents/{TITLE_ID}/romfs/Script/scr1070.binu8"
    if scene_rel not in cur_files:
        errors.append("missing_new_scene1070")
