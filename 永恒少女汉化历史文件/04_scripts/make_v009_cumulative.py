#!/usr/bin/env python3
"""Combine the known-good v005 text baseline with reviewed scene 1040."""
...
INPUTS = [
    ROOT / "03_text" / "translated" / "v005-cumulative.tsv",
    ROOT / "03_text" / "translated" / "scene1040-full-v1.tsv",
]
OUTPUT = ROOT / "03_text" / "translated" / "v009-cumulative.tsv"
